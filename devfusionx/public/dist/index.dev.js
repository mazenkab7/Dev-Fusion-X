...
fontLoader.load('https://cdn.rawgit.com/mrdoob/three.js/r127/examples/fonts/helvetiker_regular.typeface.json', function (font) {
  defaultFont = font; // Call a function to add text to the scene once the font is loaded
...
function addTextToScene(text, position, fontSize) {
  ...
  var textGeometry = new THREE.TextBufferGeometry(text, {
    ...
    height: 0.1,
    // Adjust the extrusion thickness
    curveSegments: 12,
    // Number of segments in the text shape
  ...
  var textMesh = new THREE.Mesh(textGeometry, textMaterial); // Position the text

  textMesh.position.copy(position); // Add the text to the scene
